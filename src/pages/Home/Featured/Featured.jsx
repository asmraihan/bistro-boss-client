    ...
    return (
        <div className="bg-fixed" style={{backgroundImage: `url(${featuredImg})`}}>
            ...
            <div className="md:flex justify-center items-center px-16 py-24 gap-10 ">
                ...
                <div>
                    <p className="my-4">Aug 20,2023</p>
                    ...
                    <button className="btn btn-outline border-t-0 border-r-0 border-l-0 text-white mt-4 hover:bg-white hover:text-black">Order Now</button>
                </div>
            </div>
            </div>
        </div>
